    ...
    if (active) {
        ...
        if (setlistTeamSelect) {
            ...
            if (loggedTeam === 'Master') { // Master
                ['Start', 'Branco', 'Amarelo', 'Laranja', 'Azul', 'Verde'].forEach(t => {
...
function applyTeamColorToSelector(teamName) {
    ...
    TS.classList.remove('team-selected-Start', 'team-selected-Branco', 'team-selected-Amarelo', 'team-selected-Laranja', 'team-selected-Azul', 'team-selected-Verde');
